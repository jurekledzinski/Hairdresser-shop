...
import "./BookingTermPolicyDetails.scss";

import BookingTermsPolicyButtonBack from "./BookingTermsPolicyButtonBack";
      ...
      <div className="booking-terms__policy-wrapper">
        ...
        <div className="booking-terms__policy-shop">
          ...
          <p className="booking-terms__policy-text">
            ...
            courseshop for your own personal use subjected to restrictions set
          ...
          <p className="booking-terms__policy-text">
            ...
            and opinions of Courseshop,its agents and/or affiliates. Comments
            reflect the views and opinions of the person who post their views
            and opinions. To the extent permitted by applicable laws, Courseshop
          ...
          <p className="booking-terms__policy-text">
            ...
            visibility of the hyperlink compensates the absence of Courseshop;
...
export default BookingTermPolicyDetails;
