...
const TableOpinions = ({
  ...
  return (
    <table className="table-opinions" {...getTableProps()}>
      <thead className="table-opinions__head">
        {checkWindowMedium
          ? headerGroups.map((headerGroups) => (
              <tr
                className="table-opinions__head-tr"
                {...headerGroups.getHeaderGroupProps()}
              >
                {headerGroups.headers.map((column) => (
                  <th
                    className="table-opinions__head-th"
      ...
      <tbody className="table-opinions__body" {...getTableBodyProps()}>
        {page.map((row) => {
          prepareRow(row);
          return (
            <tr className="table-opinions__body-tr" {...row.getRowProps()}>
              {row.cells.map((cell) => {
                return (
                  <td
                    className="table-opinions__body-td--courses"
                    {...cell.getCellProps()}
                  >
                    {cell.render("Cell")}
                  </td>
