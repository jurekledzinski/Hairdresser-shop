  ...
  return (
    <article className="team-details">
      <div className="team-details__wrapper">
        <h2 className="team-details__title">Our Team</h2>
        <div className="team-details__wrapper-subtitle">
          <p className="team-details__subtitle">
        ...
        <div className="team-details__team">
          <div className="team-details__box-1">
            ...
            <div className="team-details__image-box-2">
              <div className="team-details__img-inside-1"></div>
              <div className="team-details__img-inside-2"></div>
            </div>
          </div>
          <div className="team-details__box-2">
            <div className="team-details__name-1">
            ...
            <div className="team-details__description-1">
              <p className="team-details__text-des-1">
                ...
                tenetur? Id, cum numquam?
              </p>
              <p className="team-details__text-des-2">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit
                nisi officia quo similique nemo commodi. Dolorum, tenetur? Id,
                cum numquam? Lorem ipsum dolor sit amet consectetur adipisicing
                elit. Odit nisi officia quo similique nemo commodi. Dolorum,
                ...
                Dolorum, tenetur? Id, cum numquam? Lorem ipsum dolor sit amet
          ...
          <div className="team-details__box-5">
            <div className="team-details__image-box-3"></div>
            <div className="team-details__image-box-2">
              <div className="team-details__img-inside-3"></div>
              <div className="team-details__img-inside-4"></div>
            </div>
          </div>
          <div className="team-details__box-6">
            <div className="team-details__name-1">
          ...
          <div className="team-details__box-9">
            <div className="team-details__image-box-4"></div>
            <div className="team-details__image-box-2">
              <div className="team-details__img-inside-5"></div>
              <div className="team-details__img-inside-6"></div>
            </div>
          </div>
          <div className="team-details__box-10">
            <div className="team-details__name-1">
